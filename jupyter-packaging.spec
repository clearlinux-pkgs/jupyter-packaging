...
%prep
%setup -q -n jupyter-packaging-0.7.9
cd %{_builddir}/jupyter-packaging-0.7.9
...
cp %{_builddir}/jupyter-packaging-0.7.9/LICENSE %{buildroot}/usr/share/package-licenses/jupyter-packaging/7a88a926691422ae250d28e9a8214e9e40469383
