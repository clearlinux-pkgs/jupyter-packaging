...
Version  : 0.10.2
Release  : 15
URL      : https://files.pythonhosted.org/packages/2e/3b/0d05a610c663e67938222fc608a606f05fe9a9ea25d98f6f3292a6a0f67f/jupyter_packaging-0.10.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/2e/3b/0d05a610c663e67938222fc608a606f05fe9a9ea25d98f6f3292a6a0f67f/jupyter_packaging-0.10.2.tar.gz
...
%prep
%setup -q -n jupyter_packaging-0.10.2
cd %{_builddir}/jupyter_packaging-0.10.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620828264
...
cp %{_builddir}/jupyter_packaging-0.10.2/LICENSE %{buildroot}/usr/share/package-licenses/jupyter-packaging/7a88a926691422ae250d28e9a8214e9e40469383
