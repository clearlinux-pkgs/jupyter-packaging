...
%prep
%setup -q -n jupyter-packaging-0.7.12
cd %{_builddir}/jupyter-packaging-0.7.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613143983
...
cp %{_builddir}/jupyter-packaging-0.7.12/LICENSE %{buildroot}/usr/share/package-licenses/jupyter-packaging/7a88a926691422ae250d28e9a8214e9e40469383
