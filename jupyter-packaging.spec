...
Version  : 0.10.5
Release  : 20
URL      : https://files.pythonhosted.org/packages/ed/c7/ade159e5481b3140e3a98c78676747915d3b166b35f78e32f9c1ef0568bd/jupyter_packaging-0.10.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/ed/c7/ade159e5481b3140e3a98c78676747915d3b166b35f78e32f9c1ef0568bd/jupyter_packaging-0.10.5.tar.gz
...
%prep
%setup -q -n jupyter_packaging-0.10.5
cd %{_builddir}/jupyter_packaging-0.10.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631716004
...
cp %{_builddir}/jupyter_packaging-0.10.5/LICENSE %{buildroot}/usr/share/package-licenses/jupyter-packaging/7a88a926691422ae250d28e9a8214e9e40469383
