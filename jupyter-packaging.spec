...
%prep
%setup -q -n jupyter_packaging-0.9.2
cd %{_builddir}/jupyter_packaging-0.9.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618843609
...
cp %{_builddir}/jupyter_packaging-0.9.2/LICENSE %{buildroot}/usr/share/package-licenses/jupyter-packaging/7a88a926691422ae250d28e9a8214e9e40469383
