...
Version  : 0.8.0
Release  : 6
URL      : https://files.pythonhosted.org/packages/99/c0/7d7008e7f17cfde0d45026e4f7726d5c6d69d7ff2a789d7a21b8be9ff76a/jupyter_packaging-0.8.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/99/c0/7d7008e7f17cfde0d45026e4f7726d5c6d69d7ff2a789d7a21b8be9ff76a/jupyter_packaging-0.8.0.tar.gz
...
%prep
%setup -q -n jupyter_packaging-0.8.0
cd %{_builddir}/jupyter_packaging-0.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616509347
...
cp %{_builddir}/jupyter_packaging-0.8.0/LICENSE %{buildroot}/usr/share/package-licenses/jupyter-packaging/7a88a926691422ae250d28e9a8214e9e40469383
